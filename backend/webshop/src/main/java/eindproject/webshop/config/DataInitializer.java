...
public class DataInitializer {
    ...
    private void initProducts(ProductRepository productRepository) {
        ...
        macbook1.setDescription("Powerful MacBook Pro with M3 Pro chip for professionals");
        ...
        macbook1.setReleaseYear(2023);
        macbook1.setChipType(MacbookChipType.M3);
        ...
        macbook4.setName("MacBook Air 15\"");
        macbook4.setDescription("Large screen MacBook Air with M2 chip");
        macbook4.setModel("MacBook Air 15\"");
        macbook4.setPrice(1299.99);
        macbook4.setStock(20);
        macbook4.setProductEnabled(true);
        macbook4.setState(State.GOOD);
        macbook4.setCategory(Category.MACBOOK);
        macbook4.setReleaseYear(2023);
        macbook4.setChipType(MacbookChipType.M2);
        macbook4.setRamSize(MacbookRamSize.GB_24);
        macbook4.setStorage(MacbookStorage.GB_512);
        macbook4.setColor(MacbookColor.GOLD);
        productRepository.save(macbook4);

        // iWatch Products
        Iwatch iwatch1 = new Iwatch();
        iwatch1.setName("Apple Watch Series 9");
        iwatch1.setDescription("Latest Apple Watch with advanced health features");
        iwatch1.setModel("Apple Watch Series 9");
        iwatch1.setPrice(399.99);
        iwatch1.setStock(30);
        iwatch1.setProductEnabled(true);
        iwatch1.setState(State.AS_NEW);
        iwatch1.setCategory(Category.IWATCH);
        iwatch1.setReleaseYear(2023);
        ...
        iwatch2.setName("Apple Watch Ultra");
        iwatch2.setDescription("Rugged Apple Watch for extreme adventures");
        iwatch2.setModel("Apple Watch Ultra");
        iwatch2.setPrice(799.99);
        iwatch2.setStock(15);
        iwatch2.setProductEnabled(true);
        iwatch2.setState(State.AS_NEW);
        iwatch2.setCategory(Category.IWATCH);
        iwatch2.setReleaseYear(2023);
        ...
        iwatch3.setName("Apple Watch SE");
        iwatch3.setDescription("Affordable Apple Watch with essential features");
        iwatch3.setModel("Apple Watch SE");
        iwatch3.setPrice(249.99);
        iwatch3.setStock(35);
        iwatch3.setProductEnabled(true);
        iwatch3.setState(State.AS_NEW);
        iwatch3.setCategory(Category.IWATCH);
        iwatch3.setReleaseYear(2023);
        iwatch3.setCaseColor(IwatchCaseColor.DARK_GREEN);
        iwatch3.setBandColor(IwatchBandColor.BEIGE);
        iwatch3.setConnectivity(IwatchConnectivity.WIFI_BLUETOOTH);
        iwatch3.setBandType(IwatchBandType.TRAIL_POLYESTER);
        productRepository.save(iwatch3);

        Iwatch iwatch4 = new Iwatch();
        iwatch4.setName("Apple Watch Series 8");
        iwatch4.setDescription("Previous generation Apple Watch with great features");
        iwatch4.setModel("Apple Watch Series 8");
        iwatch4.setPrice(299.99);
        iwatch4.setStock(28);
        iwatch4.setProductEnabled(true);
        iwatch4.setState(State.GOOD);
        iwatch4.setCategory(Category.IWATCH);
        iwatch4.setReleaseYear(2022);
